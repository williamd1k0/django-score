"""
Django settings for django_score project.
...
INSTALLED_APPS = [
    ...
    'game_sample.apps.GameSampleConfig'
]
...
ROOT_URLCONF = 'django_score.urls'
...
WSGI_APPLICATION = 'django_score.wsgi.application'
...
if DEBUG:
    ...
    DATABASES['default'] = {
        ...
        'NAME': os.environ.get('DJANGO_DB_NAME'), # Or path to database file if using sqlite3.
